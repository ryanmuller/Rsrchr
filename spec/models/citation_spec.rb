...
describe Citation do
  ...
  describe "when creating from bibtex" do
    ...
    before(:each) do
      ...
      @bibtex = "@article{#{@citekey}, author = {#{@a1} and Sweller, J. and Clark, R.E.}, journal = {Educational psychologist}, number = {2}, pages = {75--86}, publisher = {Taylor \& Francis}, title = {Why minimal guidance during instruction does not work: An analysis of the failure of constructivist, discovery, problem-based, experiential, and inquiry-based teaching}, volume = {41}, year = {2006}}"
    end
